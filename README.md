...
I'm a Software Engineer & Content Creator, I'm passionate about Frontend Development, sharing knowledge, documentation, web engineering, MERN Stack, WEb 3, and others. I create technical content (on my [Blog](https://dev.to/blakcoder) and [YouTube](https://www.youtube.com/channel/UCkCygRifJMUpr8SrDLvc0Bg)), build useful [open-source projects](https://github.com/anslemkelechi), build technical communities
